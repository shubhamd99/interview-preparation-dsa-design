...
// Array.from({ length: rows }, () => 0) creates an array with 5 elements, all initialized to 0.
// If col is even, it calculates rows * col + (row + 1).
// Otherwise, it calculates rows * (col + 1) - row.
